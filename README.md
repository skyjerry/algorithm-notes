...
* [source code](https://github.com/zaynme/algorithm-notes/blob/main/2021-02-28/sort-list.go?ts=4)
- [x] [23. 合并K个升序链表](https://leetcode-cn.com/problems/merge-k-sorted-lists/)
* [source code](https://github.com/zaynme/algorithm-notes/blob/main/2021-02-28/merge-k-sorted-lists.go?ts=4)
- [x] [234. 回文链表](https://leetcode-cn.com/problems/palindrome-linked-list/)
* [source code](https://github.com/zaynme/algorithm-notes/blob/main/2021-02-28/palindrome-linked-list.go?ts=4)
